module ApplicationHelper
  ...
  def avatar_tag(user, options = {})
    ...
    href = user.user_profile.gravatar_hash.nil? ? image_path("default_twets_avatar.png") : "http://www.gravatar.com/avatar/#{user.user_profile.gravatar_hash}"
    image_tag href, options
  end
end
